...
export default function Introduction() {
  return (
    <div className="flex w-full h-[70vh] pl-[10%] pr-[10%] 2xl:pl-[20%] 2xl:pr-[20%] text-[3rem] flex-col md:text-[4rem] font-bold text-black mt-[5rem] md:mt-[8rem]">
        ...
        <div className="flex pt-[2rem]">
          <a href="https://drive.google.com/file/d/1nKF7vZSNsRLOrthZj7m4Emk4ImQX8HBn/view?usp=sharing" className="relative py-3 font-bold text-black group w-[15rem]">
            ...
            <span className="relative text-[1.5rem] flex items-center justify-center group-hover:text-white"> Resume </span>
          </a>
        </div>

        <div className="flex flex-row mt-[5rem] md:mt-[8rem] space-x-5">
